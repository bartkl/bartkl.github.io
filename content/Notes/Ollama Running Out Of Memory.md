...
What happens here is that Ollama overestimates the amount of layers it offloads to the GPU, causing to much memory to be asked of it.
...
I don't exactly know why this issue still occurs on my machine, but hardcoding a safe amount of layers yourself is a workaround (described in the issue #618 above) that works for me. The estimation Ollama did is, as you can read in the log above, to offload 19 layers. I managed to avoid out of memory errors using 15 layers.
